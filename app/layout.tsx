...
// Tells browsers this site is light-themed only, so mobile browsers'
// auto-dark-mode / "force dark" features don't invert or recolor text
// that was never designed for a dark background (this was causing the
// mobile nav menu's navy-on-white text to render invisible). Next.js
// requires this in a separate `viewport` export, not `metadata`.
